...
DiectoryToEvaluate = 'E:\Neuron\2014_10_17_Pair_2_0'; % Path to the data, rez file and more
RecordFile = strcat(DiectoryToEvaluate, '\amplifier2014-10-17T18_19_09.bin');
...
filterType = 'Dsort'; % Filter Type 'Kilosort', 'Dsort'
...
MaximumNumberOfTemplates = 41; % Maximum number of templates
...
MaximumNumberOfTemplateSamples = 40; % Maximum length of the time samples in the templates 
% ------------------------------------------------- Matching Setup -----------------------------------------------
