function [ r ] = TemplateLaplacianNSSD( inputSignal, templateSignal, PlotRunning, PrintProgress, ShowFunctionTime, pathToXCorFunc  )
...
r = TemplateNSSD( L1, L2, PlotRunning, PrintProgress, ShowFunctionTime );
