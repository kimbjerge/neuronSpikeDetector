function [ r ] = TemplateSAD( inputSignal, templateSignal, PlotRunning, PrintProgress, ShowFunctionTime )
%TEMPLATESAD Summary of this function goes here
...
%     meanArray = mean(InputSamples_Array);
%     
%     if meanArray < 0
%         InputSamples_Array = InputSamples_Array + abs(meanArray);
%     else
%        InputSamples_Array = InputSamples_Array - meanArray; 
%     end
...
if( strcmp(ShowFunctionTime, 'YES') == 1)
    ElapsedTime = toc;
    fprintf('TemplateSAD execution time: %.2f seconds.\n', ElapsedTime);
end
