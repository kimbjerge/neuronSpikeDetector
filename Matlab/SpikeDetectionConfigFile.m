...
%% Setup and constants
% -------------------------------------------- Simulated data  --------------------------------------------------
UsingSimulatedData = 'YES'; % Is the data simulated, If it is is uses the real grundtruth instead of kilosort to train upon
...
% --------------------------------------------- Kernel filtering -------------------------------------------------
KernelFilterToTest = 'Laplacian'; % Select between posible kernel filter types: 'Laplacian', 'GradientX','GradientY', 'None'
